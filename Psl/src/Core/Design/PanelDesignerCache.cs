...
namespace Psl.Design {
  ...
  /// <summary>
  /// Classe proposant un cache et des services associés à un <see cref="PanelDesigner"/>.
  /// </summary>
  ...
  public class PanelDesignerCache<TControl, TDesigner> : PanelDesigner
    where TControl : Control
    where TDesigner : PanelDesigner {
    ...
    /// </summary>
    public class Cache : ParentControlDesignerCache<TControl, TDesigner>.Cache {
