...
namespace Psl.Converters {
  ...
  public class EnumFlagsConverter : EnumConverter {
    ...
    /// <summary>
    /// Détermine si le convertisseur supporte un type de propriété 
    /// </summary>
    /// <param name="context">contexte associé au type</param>
    /// <returns>true si le type supporté</returns>
    ...
    /// <summary>
    /// Détermine si le convertisseur supporte les valeurs standard du type
    /// </summary>
    /// <param name="context">contexte du type</param>
    /// <returns>true si les valeurs standard sont supportées</returns>
